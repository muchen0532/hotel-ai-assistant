...
public class QdrantSearchService {
    ...
    /** Returns restaurant names ranked by semantic similarity. */
    ...
    /** Returns attraction names ranked by semantic similarity. */
    ...
    /** Returns FAQ answers for semantic search (used for general question matching). */
