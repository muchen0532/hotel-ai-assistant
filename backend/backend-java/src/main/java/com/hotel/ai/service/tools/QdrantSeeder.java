...
import com.hotel.ai.repository.AttractionRepository;
import com.hotel.ai.repository.FaqRepository;
import com.hotel.ai.repository.HotelRepository;
import com.hotel.ai.repository.RestaurantRepository;
...
public class QdrantSeeder implements CommandLineRunner {
    ...
    private void ensureCollection(String name) throws Exception {
        ...
        qdrantClient.listCollectionsAsync().get().forEach(existing::add);
